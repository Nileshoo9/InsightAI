...
export function AuthForm({ mode }: Props) {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="glass-card-static w-full max-w-md space-y-6 p-8 animate-scale-in"
    >
      {/* Header */}
      ...
      {error && (
        <div
          className="rounded-xl px-4 py-3 text-sm font-medium animate-slide-down"
      ...
      <button
        ...
        disabled={loading}
        suppressHydrationWarning
        className="primary-btn w-full px-6 py-3 text-sm"
      >
        {loading ? (
          <>
      ...
      <div className="grid grid-cols-2 gap-3">
        <button type="button" className="secondary-btn px-4 py-2.5 text-sm" disabled>
